...
- (void) stealSession {
    ...
    NSURL *url = [NSURL fileURLWithPath:@"http://www.noiseaddicts.com/samples_1w72b820/292.mp3"];
    ...
    BOOL success;
    success &= [[AVAudioSession sharedInstance] setActive:YES error:&setCategoryError];
    ...
    /*
    For test
    Ambient	Plays sound combined with any background sounds being played by other apps.	No sound from your app.
    SoloAmbient (DEFAULT)	Plays your sound and stops sound from other apps.	No sound from your app.
    Playback	Plays your sound and stops sound from other apps. Can mix audio with sound from other apps, but does not by default.2	Plays your sound and stops sound from other apps. Can mix audio with sound from other apps, but does not by default.2
    Record	No sound from your app.	No sound from your app.
    PlayAndRecord	Plays your sound and stops sound from other apps. Can mix audio with sound from other apps, but does not by default.2	Plays your sound and stops sound from other apps. Can mix audio with sound from other apps, but does not by default.2
    AudioProcessing	No sound from your app.	No sound from your app.
    MultiRoute	Plays your sound and stops sound from other apps.	Plays your sound and stops sound from other apps.


    setCategory:
                Constants
            static var mixWithOthers: AVAudioSessionCategoryOptions
            ...
            static var allowBluetooth: AVAudioSessionCategoryOptions
            Determines whether Bluetooth handsfree devices appear as available input routes.

            static var allowBluetoothA2DP: AVAudioSessionCategoryOptions
            ...
            static var allowAirPlay: AVAudioSessionCategoryOptions
            Determines whether audio from this session can be streamed to AirPlay devices.

            static var defaultToSpeaker: AVAudioSessionCategoryOptions
